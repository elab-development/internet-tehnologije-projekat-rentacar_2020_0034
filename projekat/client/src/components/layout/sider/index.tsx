        ...
        <ListItemButton
          ...
          sx={{
            ...
            "&.Mui-selected": {
              "&:hover": {
                backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWYi159cmBE7C74cPAK2afrz5MkcZnvUm6XNu_rZnjVr0rX8rF6HoGmTrvknMiAqoy7gs&usqp=CAU")',
                borderTop: "2px solid darkred", // Specifies the top border style, width, and color
      ...
      >
        ...
        <Drawer
          ...
          sx={{
            ...
            "& .MuiDrawer-paper": {
              width: drawerWidth,
              backgroundImage: 'url("https://i.pinimg.com/736x/50/f0/e5/50f0e5292151ec8552a8ad56a031ba3b.jpg")',
        ...
        >
          ...
          >
            {collapsed ? <IoMdArrowDroprightCircle style={{height:"30px", width:"30px"}}/> : <IoMdArrowDropleftCircle style={{height:"30px", width:"30px"}}/>}
          </Button>
        </Drawer>
        <Box
          sx={{
